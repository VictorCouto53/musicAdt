<?php
    class Playlist {
        ...
        public function getNumberSongs() {
            $query = mysqli_query($this->con, "SELECT songId FROM SongsPlaylist WHERE playlistId='$this->id'");
            return mysqli_num_rows($query);
        }

        public function getSongs() {
            $query = mysqli_query($this->con, "SELECT songId FROM SongsPlaylist WHERE playlistId='$this->id' ORDER BY playlistOrder ASC");
